...
class GMF(torch.nn.Module):
    ...
    def forward(self, user_indices, movie_indices):
        logits = (self.user_factors(user_indices) * self.item_factors(movie_indices)).sum(1, keepdim=True)
...
# Save the results
writer.export_scalars_to_json(f"results/centralized_mf_{args.epochs}_{args.embed_size}_{args.batch_size}_{args.learning_rate}_{args.weight_decay}.json")
writer.close()
